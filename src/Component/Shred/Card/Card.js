...
const Card = () => {
    ...
    console.log(priceReview);
    const convertDays = parseFloat(days);
    const convertPrice = parseFloat(priceReview.price);
...
//     const calculate = (service, cleaning) => {
//         const integerId = Math.round(service, cleaning);
//         return integerId;
//     };
...
//     const integer = calculate(service_fee);
//     const integers = calculate(cleaning_fee,);
//     calculate()
